                ...
                <div class="max-w-5xl mx-auto px-3 sm:px-4 py-2 sm:py-3 flex justify-between">
                    ...
                    <button type="button"
                            ...
                            @click="
                                ...
                                (step === 6 && (!document.querySelector('[name=first_name]').value || !document.querySelector('[name=last_name]').value)) ? document.querySelector('form .form-step[data-step=\'6\'] [required]:invalid').reportValidity() :
                                nextStep()
                            "
                            :disabled="formSubmitting"
