...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full bg-white rounded-xl shadow-sm p-8 space-y-8">
            <div class="text-center">
                <img src="{{ asset('images/bisu_logo.png') }}" alt="BISU Logo" class="h-20 mx-auto mb-8">
                <h2 class="text-2xl font-semibold text-gray-800">Set Up Your Password</h2>
                <p class="text-gray-500 mt-3 text-sm">Please create a secure password for your department account.</p>
            </div>
