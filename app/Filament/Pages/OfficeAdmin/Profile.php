...
namespace App\Filament\Pages\OfficeAdmin;
...
class Profile extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.pages.office-admin.profile';
                        ...
                        \Filament\Forms\Components\Section::make('Profile Picture')
                            ...
                            ->schema([
                                FileUpload::make('avatar')
                                    ...
                                    ->image()
                                    ->disk('public')
                                    ->directory('avatars/office-admin')
    ...
    {
        return auth()->user()->role === 'office-admin';
    }
}